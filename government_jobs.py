"""
    The weighted round
    input: party and their mandates
    output: random their preferences and for any party list of the jobs the are got
...
if __name__ == '__main__':
    gover_office = ["Prime Minister office", "The Deputy Prime Minister office", "Ministry of Settlement",
                    ...
                    "Ministry of Education", "Ministry of Communication", "Ministry of laws",
                    "Jerusalem Office and Heritage",
                    "Ministry of Energy", "Ministry of Foreign Affairs", "Ministry of Economy and Industry",
                    "Ministry of Intelligence",
                    "Ministry of Welfare and Social Security", "Ministry of Social Equality", "Ministry of Tourism",
                    "Ministry of Defence",
                    "Ministry of Innovation, Science and Technology", "Ministry of Immigration and Integration",
                    "Ministry of Culture and Sports",
                    "Ministry of Internal Security", "Ministry of Transportation", "Ministry of Diaspora",
                    "Ministry of Finance",
                    "Ministry of Agriculture and Rural Development",
                    "Ministry of Peripheral, Negev and Galilee Development",
                    "Ministry of Health", "Ministry of Environmental Protection", "Ministry of Regional Cooperation"
                    ]
    random.seed(0)
    number_of_coalition = int(input("enter number of party in coalition\n"))
    coalition_list = []
    for i in range(number_of_coalition):

        party_name = input("enter party name\n")
        party_mandates = int(input("enter mandates total\n"))
        party_preferences = dict()
        for office in gover_office:
            val_right = random.randint(1, 10)
            party_preferences[office] = val_right
        new_party = party(party_name, party_mandates, party_preferences)
        coalition_list.insert(-1, new_party)
    y = float(input("enter y val\n"))
    loot_distribution(y, gover_office, coalition_list)
    for z in coalition_list:
